...
class login_page:
    def __init__(self, top=None):
        ...
        self.button1.configure(text="""تسجيل دخول""")
    ...
    def login(self, Event=None):
        ...
        if results:
            if results[0][6]=="Admin":
                ...
                messagebox.showerror("عذرا!!", "انت لست من المديرين")

        else:
            messagebox.showerror("خطأ", "الاسم او كلمة المرور خطأ")
            page1.entry2.delete(0, END)

    
def exitt():
    sure = messagebox.askyesno("الخروج","هل تريد الخروج من البرنامج؟", parent=root)
    if sure == True:
        adm.destroy()
        root.destroy()
...
class Admin_Page:
    def __init__(self, top=None):
        ...
        self.button2.configure(text="""المخزن""")
    ...
    def Logout(self):
        sure = messagebox.askyesno("تسجيل الخروج", "هل تريد تسجيل الخروج من البرنامج؟", parent=adm)
        if sure == True:
            adm.destroy()
            root.deiconify()
            page1.entry1.delete(0, END)
...
class Inventory:
    def __init__(self, top=None):
        ...
        self.button1.configure(borderwidth="0")
        self.button1.configure(text="""البحث""")
        ...
        self.button2.configure(font="-family {Poppins SemiBold} -size 12")
        self.button2.configure(borderwidth="0")
        self.button2.configure(text="""تسحيل الخروج""")
        ...
        self.button4.configure(font="-family {Poppins SemiBold} -size 12")
        self.button4.configure(borderwidth="0")
        self.button4.configure(text="""تحديث منتج""")
        ...
        self.button5.configure(text="""مسح منتج""")
    ...
    def search_product(self):
        ...
        try:
            ...
            messagebox.showerror("عذرا!!", "رقم منتج غير صحيح", parent=inv)
        else:
            for search in val:
                if search==to_search:
                    self.tree.selection_set(val[val.index(search)-1])
                    self.tree.focus(val[val.index(search)-1])
                    messagebox.showinfo("!!ناجح", "رقم المنتج: {} موجود.".format(self.entry1.get()), parent=inv)
                    break
            else: 
                messagebox.showerror("!!عذرا", "رقم المنتج: {} غير موجود.".format(self.entry1.get()), parent=inv)
    ...
    def delete_product(self):
        ...
        if len(self.sel)!=0:
            sure = messagebox.askyesno("تأكيد", "هل أنت متأكد أنك تريد حذف المنتجات المحددة؟", parent=inv)
            if sure == True:
                for i in self.sel:
                    for j in self.tree.item(i)["values"]:
                        val.append(j)
                ...
                messagebox.showinfo("!!ناجح", "تم الحذف من المخزن", parent=inv)
                self.sel.clear()
                self.tree.delete(*self.tree.get_children())

                self.DisplayData()
        else:
            messagebox.showerror("!!خطأ","لرجاء اختيار منتج", parent=inv)
    ...
    def update_product(self):
        if len(self.sel)==1:
            ...
            messagebox.showerror("خطأ","الرجاء اختيار منتج لتحديثه", parent=inv)
        else:
            messagebox.showerror("خطأ","يمكن تحديث منتج واحد فقط في كل مرة", parent=inv)
    ...
    def Exit(self):
        sure = messagebox.askyesno("الخروج","هل أنت متأكد أنك تريد الخروج؟", parent=inv)
        if sure == True:
            inv.destroy()
            adm.deiconify()

    def ex2(self):
        sure = messagebox.askyesno("الخروج","هل أنت متأكد أنك تريد الخروج؟", parent=p_update)
        if sure == True:
            p_update.destroy()
            inv.deiconify()
    ...
    def Logout(self):
        sure = messagebox.askyesno("تسجيل الخروج", "هل أنت متأكد أنك تريد تسجيل الخروج؟")
        if sure == True:
            root.deiconify()
            page1.entry1.delete(0, END)
            page1.entry2.delete(0, END)
...
class add_product:
    def __init__(self, top=None):
        ...
        self.button2.configure(borderwidth="0")
        self.button2.configure(text="""مسح""")
                    ...
                    if pqty:
                        if pcp:
                            try:
                                ...
                                messagebox.showerror("!عذرا", "سعر التكلفة غير صالح", parent=p_add)
                            else:
                                if pmrp:
                                    try:
                                        float(pmrp)
                                    except ValueError:
                                        messagebox.showerror("!عذرا", "سعرالبيع غير صالح" , parent=p_add)
                                    else:
                                        if valid_phone(pvendor):
                                            ...
                                            db.commit()
                                            messagebox.showinfo("!!نجاح", "تمت إضافة المنتج بنجاح إلى المخزن.", parent=p_add)
                                            p_add.destroy()
                                            page3.tree.delete(*page3.tree.get_children())
                                            page3.DisplayData()
                                            p_add.destroy()
                                        else:
                                            messagebox.showerror("!عذرا", "رقم هاتف غير صحيح", parent=p_add)
                                else:
                                    messagebox.showerror("!عذرا", "عذرا اضف سعر بيع", parent=p_add)
                        else:
                            messagebox.showerror("!عذرا", "عذرا اضف سعر المنتج", parent=p_add)
                    else:
                        messagebox.showerror("!عذرا", "عذرا اضف كمية المنتج", parent=p_add)
                else:
                    messagebox.showerror("!عذرا", "الرجاء إدخال فئة المنتج الفرعية", parent=p_add)
            else:
                messagebox.showerror("!عذرا", "الرجاء إدخال فئة المنتج", parent=p_add)
        else:
            messagebox.showerror("!عذرا", "الرجاء إدخال اسم المنتج", parent=p_add)
...
class Update_Product:
    def __init__(self, top=None):
        ...
        self.button1.configure(font="-family {Poppins SemiBold} -size 14")
        self.button1.configure(borderwidth="0")
        self.button1.configure(text="""تحديث""")
        ...
        self.button2.configure(font="-family {Poppins SemiBold} -size 14")
        self.button2.configure(borderwidth="0")
        self.button2.configure(text="""حذف""")
        self.button2.configure(command=self.clearr)
                    ...
                    if pqty:
                        if pcp:
                            try:
                                ...
                                messagebox.showerror("!عذرا", "سعر التكلفة غير صالح", parent=p_update)
                            else:
                                if pmrp:
                                    try:
                                        float(pmrp)
                                    except ValueError:
                                        messagebox.showerror("!عذرا", "سعر البيع غير صالح", parent=p_update)
                                    else:
                                        if valid_phone(pvendor):
                                            product_id = valll[0]
                                            with sqlite3.connect("./Database/store.db") as db:
                                            ...
                                            db.commit()
                                            messagebox.showinfo("!!نجاح", "تم تحديث المنتج بنجاح في المخزن", parent=p_update)
                                            valll.clear()
                                            Inventory.sel.clear()
                                            page3.tree.delete(*page3.tree.get_children())
                                            page3.DisplayData()
                                            ...
                                            messagebox.showerror("!عذرا", "رقم الهاتف غير صحيح", parent=p_update)
                                else:
                                    messagebox.showerror("!عذرا", "اضف سعر بيع ", parent=p_update)
                        else:
                            messagebox.showerror("!عذرا", "عذرا اضف سعر المنتج", parent=p_update)
                    else:
                        messagebox.showerror("!عذرا", "عذرا اضف كمية المنتج", parent=p_update)
                else:
                    messagebox.showerror("!عذرا", "الرجاء إدخال الفئة الفرعية للمنتج", parent=p_update)
            else:
                messagebox.showerror("!عذرا", "الرجاء إدخال فئة المنتج", parent=p_update)
        else:
            messagebox.showerror("!عذرا", "عذرا اضف اسم المنتج", parent=p_update)
...
class Employee:
    def __init__(self, top=None):
        ...
        self.button2.configure(font="-family {Poppins SemiBold} -size 12")
        self.button2.configure(borderwidth="0")
        self.button2.configure(text="""تسجيل خروج""")
        self.button2.configure(command=self.Logout)
        ...
        self.button4.configure(font="-family {Poppins SemiBold} -size 12")
        self.button4.configure(borderwidth="0")
        self.button4.configure(text="""تحديث موظف""")
    ...
    def search_emp(self):
        ...
        for search in val:
            if search==to_search:
                self.tree.selection_set(val[val.index(search)-1])
                self.tree.focus(val[val.index(search)-1])
                messagebox.showinfo("!!نجاح", "رقم الموظف: {} موجود.".format(self.entry1.get()), parent=emp)
                break
        else: 
            messagebox.showerror("Oops!!", "رقم الموظف: {} ليس موجود.".format(self.entry1.get()), parent=emp)
    ...
    def delete_emp(self):
        ...
        if len(self.sel)!=0:
            sure = messagebox.askyesno("تأكيد", "هل انت متأكد من انك تريد ازالة الموظف ؟", parent=emp)
            if sure == True:
                for i in self.sel:
                    for j in self.tree.item(i)["values"]:
                        val.append(j)
                ...
                if flag==1:
                    messagebox.showinfo("!!نجاح", "تمت ازالة الموظف", parent=emp)
                    self.sel.clear()
                    self.tree.delete(*self.tree.get_children())
                    self.DisplayData()
                else:
                    messagebox.showerror("!!خطأ","لا يمكنك ازالة الادمن الاساسي")
        else:
            messagebox.showerror("!!خطأ","عذرا قم باختيار موظف", parent=emp)
    ...
    def update_emp(self):
        ...
        if len(self.sel)==1:
            ...
            messagebox.showerror("خطأ","عذرا قم باختيار موظف للتحديث")
        else:
            messagebox.showerror("خطأ","يمكن تحديث موظف واحد فقط في كل مرة")
    ...
    def Exit(self):
        sure = messagebox.askyesno("خروج","هل أنت متأكد أنك تريد الخروج؟", parent=emp)
        if sure == True:
            emp.destroy()
            adm.deiconify()
    ...
    def Logout(self):
        sure = messagebox.askyesno("تسجيل خروج", "هل أنت متأكد أنك تريد تسجيل الخروج؟")
        if sure == True:
            emp.destroy()
            root.deiconify()
                    ...
                    if edes:
                        if eadd:
                            if epass:
                                ...
                                db.commit()
                                messagebox.showinfo("!!نجاح", "هوية الموظف: {} أضيف بنجاح".format(emp_id), parent=e_add)
                                self.clearr()
                            else:
                                messagebox.showerror("!عذرا", "الرجاء إدخال كلمة المرور", parent=e_add)
                        else:
                            messagebox.showerror("!عذرا", "الرجاء إدخال العنوان", parent=e_add)
                    else:
                        messagebox.showerror("!عذرا", "الرجاء إدخال التعيين", parent=e_add)
                else:
                    messagebox.showerror("!عذرا", "رقم البطاقة غير صالح", parent=e_add)
            else:
                messagebox.showerror("!عذرا", "رقم الهاتف غير صحيح", parent=e_add)
        else:
            messagebox.showerror("!عذرا", "الرجاء إدخال اسم الموظف", parent=e_add)
                    ...
                    if edes:
                        if eadd:
                            if epass:
                                ...
                                db.commit()
                                messagebox.showinfo("!!نجاح", "هوية الموظف: {} تم التحديث بنجاح".format(emp_id), parent=e_update)
                                vall.clear()
...
class Invoice:
    def __init__(self, top=None):
        ...
        self.button3.configure(font="-family {Poppins SemiBold} -size 12")
        self.button3.configure(borderwidth="0")
        self.button3.configure(text="""مسح السجل""")
    ...
    def delete_invoice(self):
        ...
        if len(self.sel)!=0:
            sure = messagebox.askyesno("تأكيد", "هل انت متأكد انك تريد ازالة الفاتوره الحالية؟", parent=invoice)
            if sure == True:
                for i in self.sel:
                    for j in self.tree.item(i)["values"]:
                        val.append(j)
                ...
                messagebox.showinfo("!!نجاح", "الفاتوره تمت ازالتها", parent=invoice)
                self.sel.clear()
                self.tree.delete(*self.tree.get_children())

                self.DisplayData()
        else:
            messagebox.showerror("!!خطأ","عذرا اختار فاتورة", parent=invoice)
    ...
    def search_inv(self):
        ...
        for search in val:
            if search==to_search:
                self.tree.selection_set(val[val.index(search)-1])
                self.tree.focus(val[val.index(search)-1])
                messagebox.showinfo("!!نجاح", "رقم الفاتوره: {} موجود.".format(self.entry1.get()), parent=invoice)
                break
        else: 
            messagebox.showerror("!!نجاح", "رقم الفاتوره: {} غير موجود.".format(self.entry1.get()), parent=invoice)


    def Logout(self):
        sure = messagebox.askyesno("تسحيل خروج","هل تريد تسجيل الخروج من البرنامج؟")
        if sure == True:
            invoice.destroy()
            root.deiconify()
            page1.entry1.delete(0, END)
    ...
    def Exit(self):
        sure = messagebox.askyesno("خروج","هل تريد الخروج من البرنامج؟", parent=invoice)
        if sure == True:
            invoice.destroy()
            adm.deiconify()
